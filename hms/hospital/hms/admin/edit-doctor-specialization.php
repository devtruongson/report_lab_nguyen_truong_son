...
<html lang="vi">
	<head>
		<title>Quản trị | Chỉnh sửa Chuyên khoa Bác sĩ</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Quản trị | Chỉnh sửa Chuyên khoa Bác sĩ</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Quản trị</span>
									...
									<li class="active">
										<span>Chỉnh sửa Chuyên khoa Bác sĩ</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Chỉnh sửa Chuyên khoa Bác sĩ</h5>
												</div>
