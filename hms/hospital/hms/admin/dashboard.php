			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Quản trị | Bảng điều khiển</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Quản trị</span>
							...
							<div class="col-sm-4">
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										...
										<h2 class="StepTitle"> Lịch hẹn</h2>
										...
										<p class="links cl-effect-1">
											<a href="book-appointment.php">
												<a href="appointment-history.php">
													...
													?>
														Tổng số Lịch hẹn :<?php echo htmlentities($num_rows2);
																		} ?>
												</a>
											</a>
										</p>
							...
							<div class="col-sm-4">
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										...
										<h2 class="StepTitle"> Câu hỏi Mới</h2>
										...
										<p class="links cl-effect-1">
											<a href="book-appointment.php">
												<a href="unread-queries.php">
													...
													?>
													Tổng số Câu hỏi mới :<?php echo htmlentities($num_rows22);   ?>
												</a>
											</a>
										</p>
									</div>
