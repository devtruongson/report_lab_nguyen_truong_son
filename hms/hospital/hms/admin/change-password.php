...
check_login();
date_default_timezone_set('Asia/Ho_Chi_Minh'); // thay đổi múi giờ theo khu vực
...
$_SESSION['msg1']="Mật khẩu đã được thay đổi thành công !!";
}
else
{
$_SESSION['msg1']="Mật khẩu cũ không đúng !!";
}
}
?>
<!DOCTYPE html>
<html lang="vi">
	<head>
		<title>Quản trị | Đổi Mật khẩu</title>
		<meta charset="utf-8" />
...
{
alert("Trường Mật khẩu hiện tại đang trống!!");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.npass.value=="")
{
alert("Trường Mật khẩu mới đang trống!!");
document.chngpwd.npass.focus();
return false;
}
else if(document.chngpwd.cfpass.value=="")
{
alert("Trường Xác nhận mật khẩu đang trống!!");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Quản trị | Đổi Mật khẩu</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Quản trị</span>
