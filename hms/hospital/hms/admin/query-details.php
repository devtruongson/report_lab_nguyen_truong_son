...
if($query){
echo "<script>alert('Nhận xét của quản trị viên đã cập nhật thành công.');</script>";
...
<html lang="vi">
	<head>
		<title>Quản trị | Chi tiết Truy vấn</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Quản trị | Chi tiết Truy vấn</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Quản trị</span>
