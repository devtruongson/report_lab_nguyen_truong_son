...
<html lang="en">
	<head>
		<title>Người dùng | Lịch sử y tế</title>
...
<td colspan="4" style="font-size:20px;color:blue">
 Thông tin chi tiết bệnh nhân</td></tr>
  ...
  <tr>
    <th scope>Số điện thoại di động của bệnh nhân</th>
  ...
  <tr>
    ...
    <th>Tiền sử bệnh nhân (nếu có)</th>
    <td><?php  echo $row['PatientMedhis'];?></td>
     <th>Ngày đăng ký bệnh nhân</th>
