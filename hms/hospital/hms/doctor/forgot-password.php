    ...
    <div class="row">
        <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
            <div class="logo margin-top-30">
                <a href="../../index.html"><h2> HMS | Khôi phục mật khẩu bác sĩ</h2></a>
            </div>
            ...
            <div class="box-login">
                <form class="form-login" method="post">
                    <fieldset>
                        <legend>
                            Khôi phục mật khẩu bác sĩ
                        </legend>
                        <p>
                            Vui lòng nhập số điện thoại đăng ký và Email của bạn để khôi phục mật khẩu.<br />
                        </p>
