...
if (isset($_POST['submit'])) {
    ...
    if ($sql) {
        echo "<script>alert('Chi tiết bác sĩ được cập nhật thành công');</script>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    <title>Bác sĩ | Chỉnh sửa thông tin bác sĩ</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Bác sĩ | Chỉnh sửa thông tin bác sĩ</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Bác sĩ</span>
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                ?>
                                                    <h4>Thông tin của <?php echo htmlentities($data['doctorName']); ?></h4>
