                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-patient.php?editid=<?php echo $row['ID']; ?>"><i class="fa fa-edit"></i></a> || <a href="view-patient.php?viewid=<?php echo $row['ID']; ?>"><i class="fa fa-eye"></i></a> || <form style="display: inline;" action="delete.php" method="POST">
                                                        <input type="hidden" name="id" value="<?php echo $row['ID']; ?>">
                                                        <input type="hidden" name="type" value="one">
                                                        <button style="background-color: transparent;" class="btn"><i class="fa fa-trash"></i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php
