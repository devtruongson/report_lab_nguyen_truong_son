...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "update tblpatient set PatientName='$patname',PatientContno='$patcontact',PatientEmail='$patemail',PatientGender='$gender',PatientAdd='$pataddress',PatientAge='$patage',PatientMedhis='$medhis', file='$file', thumbnail='$thumbnail' where ID='$eid'");
    if ($sql) {
        echo "<script>alert('Thông tin bệnh nhân được cập nhật thành công');</script>";
                                                ...
                                                <form role="form" name="" method="post">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" name="medhis" class="form-control" placeholder="Nhập lịch sử bệnh án của bệnh nhân (nếu có)" required="true"><?php echo $row['PatientMedhis']; ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="fess">
                                                                Ngày tạo
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="<?php echo $row['thumbnail']; ?>" type="file" id="avatar_input" name="fileToUpload" accept="image/png, image/gif, image/jpeg">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="doctorname">
                                                                File (Docx, Excel...)
                                                            </label>
                                                            <input value="<?php echo $row['file']; ?>" class="form-control" type="file" id="file_input" name="fileToUpload">
                                                        </div>
                                                    <?php } ?>
